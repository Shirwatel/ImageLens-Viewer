...
async function init() {
  ...
  renderZoomSeg();
  document.getElementById("upscaleSmallImages").checked = settings.upscaleSmallImages;
  ...
  document.getElementById("toolbarTransparent").checked = settings.toolbarTransparent;
  document.getElementById("toolbarColor").value = settings.toolbarColor;
  document.getElementById("toolbarColorValue").textContent = settings.toolbarColor;
...
document.getElementById("upscaleSmallImages").addEventListener("change", (e) => {
  persist({ upscaleSmallImages: e.target.checked });
});
...
document.getElementById("toolbarTransparent").addEventListener("change", (e) => {
  persist({ toolbarTransparent: e.target.checked });
});

document.getElementById("toolbarColor").addEventListener("input", (e) => {
  document.getElementById("toolbarColorValue").textContent = e.target.value;
  persist({ toolbarColor: e.target.value });
});

document.getElementById("toolbarColorReset").addEventListener("click", () => {
  const val = DEFAULTS.toolbarColor;
  document.getElementById("toolbarColor").value = val;
  document.getElementById("toolbarColorValue").textContent = val;
  persist({ toolbarColor: val });
});
...
document.getElementById("uiAutoHide").addEventListener("change", (e) => {
  persist({ uiVisibility: e.target.checked ? "auto" : "always" });
});
